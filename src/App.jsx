...
function App() {
  ...
  const fetchItems = () => {
    fetch('https://bookstore-5695e.firebaseio.com/books/.json')
  ...
  const addBook = (newBook) => {
    fetch('https://todolist-a1048.firebaseio.com/books/.json',
    {
       method: 'POST',
  ...
  const deleteBook = (id) => {
     fetch(`https://todolist-a1048.firebaseio.com/books/${id}.json`,
    {
      method: 'DELETE',
    })
    .then(response => fetchItems())
